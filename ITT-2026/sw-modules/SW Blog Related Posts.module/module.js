// ===============================
// Smithworks' SW Blog Related Posts module.js
// SW Category: Sections
// Master version number: 2026.02.27.12.11
...
(function() {
  ...
  function runEmbedLogic() {
    var selectorRoot = '.sw-blog-cards--has-bg-video';
  ...
  function initBlazeSliders() {
    var blazeSliders = document.querySelectorAll('.sw-blog-cards .blaze-slider');
  ...
  function initInfiniteScroll() {
    var containers = document.querySelectorAll('.sw-blog-cards__infinite-scroll');
    if (containers.length === 0) return;

    containers.forEach(function(container) {
      var trigger = container.dataset.loadTrigger || '';
      var chunks = container.querySelectorAll('.sw-blog-cards__chunk');
      var loadMoreBtn = container.querySelector('.sw-blog-cards__load-more');
      var sentinel = container.querySelector('.sw-blog-cards__sentinel');

      function revealNextChunk() {
        var hidden = container.querySelectorAll('.sw-blog-cards__chunk--hidden');
        if (hidden.length > 0) {
          hidden[0].classList.remove('sw-blog-cards__chunk--hidden');
  ...
  function startSlideBounce(sliderEl) {
    ...
    setInterval(function() {
      container.classList.add('sw-blog-cards__bounce');
      setTimeout(function() {
        container.classList.remove('sw-blog-cards__bounce');
      }, 500);
    }, intervalMs);
  }
